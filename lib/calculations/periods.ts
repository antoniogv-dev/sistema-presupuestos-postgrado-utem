...
export function getAnnualTuitionChargePeriods(
  ...
  // mantiene actividad. En cohortes que comienzan en 2S, esto permite reconocer
  // también el último 1S, que cae en un tercer año calendario para programas de 4 semestres.
