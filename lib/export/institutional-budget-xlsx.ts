...
export async function createInstitutionalFormulaBudgetXlsx(
  ...
  s3 = setFormula(s3, `G${directCostRow}`, `+G${totalHoursRow}*Parámetros!B7`, flow1.directTeachingCost); s3 = setFormula(s3, `H${directCostRow}`, `+H${totalHoursRow}*Parámetros!C7`, flow2.directTeachingCost);
  ...
  const repHours1 = replacementHoursForYear(budget, year1); const repHours2 = replacementHoursForYear(budget, year2); s4 = setFormula(s4, "B9", `-${repHours1}*Parámetros!B8`, -flow1.replacementTeachingCost); s4 = setFormula(s4, "C9", `-${repHours2}*Parámetros!C8`, -flow2.replacementTeachingCost);
  s4 = setFormula(s4, "B10", `-'Flujo estudiantes'!B${graduationStudentsRow}*Parámetros!$B$9`, -flow1.thesisGuidanceCost); s4 = setFormula(s4, "C10", `-'Flujo estudiantes'!C${graduationStudentsRow}*Parámetros!$C$9`, -flow2.thesisGuidanceCost); s4 = setFormula(s4, "B11", "SUM(B8:B10)", -flow1.academicHonoraria); s4 = setFormula(s4, "C11", "SUM(C8:C10)", -flow2.academicHonoraria);
