    ...
    <div className="dashboard-grid import-export-grid">
      ...
      <section className="panel">
        ...
        <div className="export-list enabled-exports">
          ...
          <button type="button" disabled={!selected || !result} onClick={() => selected && result && void runExport(() => downloadBudgetPdf(selected, result, parameters, budgets), "Reporte de viabilidad exportado a PDF.")}><span><strong>Reporte de viabilidad</strong><small>PDF con portada institucional, flujo, análisis financiero y parámetros</small></span><span>Exportar PDF</span></button>
          <button type="button" disabled={!selected || !result} onClick={() => selected && result && void runExport(() => downloadBudgetMemorandum(selected, result, parameters), "Memorándum institucional generado.")}><span><strong>Memorándum presupuestario</strong><small>DOCX institucional con antecedentes, principales supuestos, flujo y resultado financiero</small></span><span>Descargar memorándum</span></button>
